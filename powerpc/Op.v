...
Inductive condition : Type :=
  ...
  | Cmaskzero: int_compcert -> condition         (**r test [(arg & constant) == 0] *)
  | Cmasknotzero: int_compcert -> condition      (**r test [(arg & constant) != 0] *)
...
(*c Integer arithmetic: *)
  ...
  | Osubimm: int_compcert -> operation           (**r [rd = n - r1] *)
  | Omul: operation                     (**r [rd = r1 * r2] *)
  | Omulimm: int_compcert -> operation           (**r [rd = r1 * n] *)
  ...
  | Oshrimm: int_compcert -> operation           (**r [rd = r1 >> n] (signed) *)
  | Oshrximm: int_compcert -> operation          (**r [rd = r1 / 2^n] (signed) *)
  | Oshru: operation                    (**r [rd = r1 >> r2] (unsigned) *)
  | Orolm: int_compcert -> int_compcert -> operation      (**r rotate left and mask *)
  | Oroli: int_compcert -> int_compcert -> operation      (**r rotate left and insert *)
(*c PPC64 64-bit integer arithmetic: *)
  ...
  | Oshrlimm: int_compcert -> operation          (**r [rd = r1 >> n] (signed) *)
  | Oshrxlimm: int_compcert -> operation         (**r [rd = r1 / 2^n] (signed) *)
  | Oshrlu: operation                   (**r [rd = r1 >> r2] (unsigned) *)
  | Orolml: int_compcert -> int64 -> operation   (**r rotate left and mask *)
...
Definition is_rlw_mask (x: int_compcert) : bool :=
