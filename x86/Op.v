...
Inductive condition : Type :=
  ...
  | Ccompimm (c: comparison) (n: int_compcert) (**r signed integer comparison with a constant *)
  | Ccompuimm (c: comparison) (n: int_compcert)  (**r unsigned integer comparison with a constant *)
  ...
  | Cmaskzero (n: int_compcert)         (**r test [(arg & constant) == 0] *)
  | Cmasknotzero (n: int_compcert).     (**r test [(arg & constant) != 0] *)
...
(*c 32-bit integer arithmetic: *)
  ...
  | Osub                     (**r [rd = r1 - r2] *)
  | Omul                     (**r [rd = r1 * r2] *)
  | Omulimm (n: int_compcert)         (**r [rd = r1 * n] *)
  ...
  | Onot                     (**r [rd = ~r1] *)
  | Oshl                     (**r [rd = r1 << r2] *)
  | Oshlimm (n: int_compcert)         (**r [rd = r1 << n] *)
  | Oshr                     (**r [rd = r1 >> r2] (signed) *)
  | Oshrimm (n: int_compcert)         (**r [rd = r1 >> n] (signed) *)
  | Oshrximm (n: int_compcert)        (**r [rd = r1 / 2^n] (signed) *)
  | Oshru                    (**r [rd = r1 >> r2] (unsigned) *)
  | Oshruimm (n: int_compcert)        (**r [rd = r1 >> n] (unsigned) *)
  | Ororimm (n: int_compcert)         (**r rotate right immediate *)
  | Oshldimm (n: int_compcert)        (**r [rd = r1 << n | r2 >> (32-n)] *)
...
(*c 64-bit integer arithmetic: *)
  ...
  | Onotl                    (**r [rd = ~r1] *)
  | Oshll                    (**r [rd = r1 << r2] *)
  | Oshllimm (n: int_compcert)        (**r [rd = r1 << n] *)
  | Oshrl                    (**r [rd = r1 >> r2] (signed) *)
  | Oshrlimm (n: int_compcert)        (**r [rd = r1 >> n] (signed) *)
  | Oshrxlimm (n: int_compcert)       (**r [rd = r1 / 2^n] (signed) *)
  | Oshrlu                   (**r [rd = r1 >> r2] (unsigned) *)
  | Oshrluimm (n: int_compcert)       (**r [rd = r1 >> n] (unsigned) *)
  | Ororlimm (n: int_compcert)        (**r rotate right immediate *)
