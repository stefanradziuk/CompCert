...
Inductive instruction: Type :=
  ...
  | Pmovl_ri (rd: ireg) (n: int_compcert)
  ...
  | Pmovb_mr (a: addrmode) (rs: ireg)   (**r [mov] (8-bit int_compcert) *)
  | Pmovw_mr (a: addrmode) (rs: ireg)   (**r [mov] (16-bit int_compcert) *)
  ...
  | Pcvttsd2si_rf (rd: ireg) (r1: freg) (**r double to signed int_compcert *)
  | Pcvtsi2sd_fr (rd: freg) (r1: ireg)  (**r signed int_compcert to double *)
  | Pcvttss2si_rf (rd: ireg) (r1: freg) (**r single to signed int_compcert *)
  | Pcvtsi2ss_fr (rd: freg) (r1: ireg)  (**r signed int_compcert to single *)
  ...
  | Pnegl (rd: ireg)
  | Pnegq (rd: ireg)
  | Paddl_ri (rd: ireg) (n: int_compcert)
  ...
  | Pimull_ri (rd: ireg) (n: int_compcert)
  ...
  | Pandl_ri (rd: ireg) (n: int_compcert)
  | Pandq_ri (rd: ireg) (n: int64)
  | Porl_rr (rd: ireg) (r1: ireg)
  | Porq_rr (rd: ireg) (r1: ireg)
  | Porl_ri (rd: ireg) (n: int_compcert)
  | Porq_ri (rd: ireg) (n: int64)
  | Pxorl_r (rd: ireg)                  (**r [xor] with self = set to zero *)
  | Pxorq_r (rd: ireg)
  | Pxorl_rr (rd: ireg) (r1: ireg)
  | Pxorq_rr (rd: ireg) (r1: ireg)
  | Pxorl_ri (rd: ireg) (n: int_compcert)
  | Pxorq_ri (rd: ireg) (n: int64)
  | Pnotl (rd: ireg)
  | Pnotq (rd: ireg)
  | Psall_rcl (rd: ireg)
  | Psalq_rcl (rd: ireg)
  | Psall_ri (rd: ireg) (n: int_compcert)
  | Psalq_ri (rd: ireg) (n: int_compcert)
  | Pshrl_rcl (rd: ireg)
  | Pshrq_rcl (rd: ireg)
  | Pshrl_ri (rd: ireg) (n: int_compcert)
  | Pshrq_ri (rd: ireg) (n: int_compcert)
  | Psarl_rcl (rd: ireg)
  | Psarq_rcl (rd: ireg)
  | Psarl_ri (rd: ireg) (n: int_compcert)
  | Psarq_ri (rd: ireg) (n: int_compcert)
  | Pshld_ri (rd: ireg) (r1: ireg) (n: int_compcert)
  | Prorl_ri (rd: ireg) (n: int_compcert)
  | Prorq_ri (rd: ireg) (n: int_compcert)
  | Pcmpl_rr (r1 r2: ireg)
  | Pcmpq_rr (r1 r2: ireg)
  | Pcmpl_ri (r1: ireg) (n: int_compcert)
  | Pcmpq_ri (r1: ireg) (n: int64)
  | Ptestl_rr (r1 r2: ireg)
  | Ptestq_rr (r1 r2: ireg)
  | Ptestl_ri (r1: ireg) (n: int_compcert)
  ...
  | Padcl_ri (rd: ireg) (n: int_compcert)
  | Padcl_rr (rd: ireg) (r2: ireg)
  | Paddl_mi (a: addrmode) (n: int_compcert)
  ...
  | Psubl_ri (rd: ireg) (n: int_compcert)
